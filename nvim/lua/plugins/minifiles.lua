-- https://github.com/MariaSolOs/dotfiles/blob/914036b9eba8996f57417307942f8af47849bc4a/.config/nvim/lua/plugins/minifiles.lua
local function map_split(buf_id, lhs, direction) local minifiles = require 'mini.files'
