-- Copied from https://github.com/liangxianzhe/floating-input.nvim/blob/main/plugin/floating-input.lua
local M = {}
...
function M.floating_input(opts, on_confirm, win_config)
...
vim.api.nvim_create_autocmd('BufWinEnter', {
  group = vim.api.nvim_create_augroup('omerta/input', { clear = true }),
  desc = 'Custom vim.ui.input',
  callback = function()
    vim.ui.input = function(opts, on_confirm)
      opts = opts or {}
      M.floating_input(opts, on_confirm, {})
    end
  end,
})
